...
<body>
    <header>
        <div class="navigation">
            <ul>
                <div class="logoensak"><a href="hello.php"><img src="images/ensaklogo.png" alt="logo de l'ensak" id="logoensak"></a></div>
        ...
        <div class="banner" id="home">
            <div class="containaire" >
                <div class="descetcomm">
                    ...
                    <p >ici ,vous pouvez visualiser les informations sur votre stage de PFE </p>
                    <a href="showinfo.php" class="button">Commencer</a>
                </div>
                <div class="imgbanner">
