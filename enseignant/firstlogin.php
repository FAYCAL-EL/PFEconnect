<?php session_start() ;
	...
	$requette="UPDATE enseignant SET photo='$ph_name' WHERE id_enseignant='$user' ";
	$resultat=mysqli_query($link,$requette);
    $req="SELECT photo FROM enseignant WHERE id_enseignant='$user'";
                        ...
                        if($datap=mysqli_fetch_assoc($resul)){
                            ...
                            if($_POST["password"]=="AZERTY" || $_POST["password"]=="azerty"){
                                echo '<div class="erreur"><i class="fas fa-minus-circle"></i>Entrer un mot de passe différent de "AZERTY" </div>';
                                    ...
                                    $mdp=$_POST["password"];
                                    $requette="UPDATE enseignant SET password='$mdp' WHERE id_enseignant='$user'";
